...
def linkprediction():
    ...
    entity2id, relation2id, train_triplets, valid_triplets, test_triplets = load_data('/home/DRN/code/RGCN/data/docred/')
    ...
    checkpoint = torch.load('checkpoint/best_mrr_model.pth')
...
def readdict():
    with open('/home/DRN/code/RGCN/data/docred/entities.dict') as f:
        entity2id = dict()
