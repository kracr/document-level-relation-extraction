...
def get_opt():
    ...
    parser.add_argument('--dataset', type=str, default="docred", choices=['docred','REDocred','DWIE'],
                        help='you should choose between docred and REDocred, DWIE')
